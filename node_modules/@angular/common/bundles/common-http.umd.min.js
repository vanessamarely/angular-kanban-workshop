...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var q=function(){function e(e,t){this.backend=e,this.injector=t,this.chain=null}return e.prototype.handle=function(e){if(null===this.chain){var t=this.injector.get(x,[]);this.chain=t.reduceRight((function(e,t){return new C(e,t)}),this.backend)}return this.chain.handle(e)},e}();function J(){return"object"==typeof window?window:{}}q.decorators=[{type:t.Injectable}],q.ctorParameters=function(){return[{type:a},{type:t.Injector}]};var B,D,K=function(){function e(){}return e.disable=function(){return{ngModule:e,providers:[{provide:F,useClass:N}]}},e.withOptions=function(t){return void 0===t&&(t={}),{ngModule:e,providers:[t.cookieName?{provide:L,useValue:t.cookieName}:[],t.headerName?{provide:z,useValue:t.headerName}:[]]}},e}();K.decorators=[{type:t.NgModule,args:[{providers:[F,{provide:x,useExisting:F,multi:!0},{provide:U,useClass:M},{provide:L,useValue:"XSRF-TOKEN"},{provide:z,useValue:"X-XSRF-TOKEN"}]}]}],(B=function B(){}).decorators=[{type:t.NgModule,args:[{imports:[K.withOptions({cookieName:"XSRF-TOKEN",headerName:"X-XSRF-TOKEN"})],providers:[k,{provide:s,useClass:q},A,{provide:a,useExisting:A},I,{provide:R,useExisting:I}]}]}],(D=function D(){}).decorators=[{type:t.NgModule,args:[{providers:[O,{provide:j,useFactory:J},{provide:x,useClass:H,multi:!0}]}]}],
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
